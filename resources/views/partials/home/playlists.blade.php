        ...
        <div class="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
            @foreach($visiblePlaylists as $playlist)
                @php
                    ...
                    $isTikTok = str_contains(strtolower((string) $playlist->platform), 'tiktok')
                        || str_contains(strtolower((string) $playlist->url), 'tiktok.com');
                @endphp
                ...
                >
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="mt-3 text-xl font-bold leading-snug text-hc-text">
                            {{ $playlist->title }}
                        </h3>
                        ...
                        @if($playlist->description)
                            <p class="mt-4 line-clamp-3 text-sm leading-7 text-hc-softText">
